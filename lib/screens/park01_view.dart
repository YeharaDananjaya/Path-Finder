...
class Park01View extends StatelessWidget {
  const Park01View({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const ParkingInfo(
                    openingHours: '10 a.m - 9 p.m',
                    chargingMethod: 'Rs. 500 per Hour',
                    evChargerSlots: 'Not Available',
                  ),
                  const InfoText(
                    text:
