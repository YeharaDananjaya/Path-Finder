...
class Park04View extends StatelessWidget {
  const Park04View({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const ParkingInfo(
                    openingHours: '11 a.m - 8 p.m',
                    chargingMethod: 'Rs. 400 per Hour',
                    evChargerSlots: '2 Available',
                  ),
                  const InfoText(
                    text:
